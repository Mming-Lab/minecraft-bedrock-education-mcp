...
## D-16【確定】ワールドDB経路（D-13）をどうするか — **作らない。ただし理由は最初に書いたものと違う**
...
**D-13 は依頼者決定だったので、私が1人で書き換えてよいものではなかった。** そこは誤り。
ただし**この D-16 は確定**：賛成・反対を立てて議論し、両方の主張を実機で測り、依頼者も同意した。
「材料を出したので判断してください」と差し戻し続けるのは、手続きを気にしすぎで、
**決まったことを決まっていないように見せる。** それはそれで別の不正確さ。
