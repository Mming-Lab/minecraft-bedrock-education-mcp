        ...
        try {
            ...
            if (result.success) {
                ...
                return this.createSuccessResponse(
                    `Structure transformed using ${transformation}${materialInfo}. Processed ${totalBlocks} original blocks, placed ${blocksPlaced} blocks at target (${target.x},${target.y},${target.z})`,
                    {
                        type: 'transformation',
                        sourceRegion: {
                            corner1: source1,
