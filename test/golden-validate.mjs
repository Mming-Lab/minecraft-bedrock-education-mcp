// Checks a geometry implementation against the golden files beside this script.
//
...
import { buildCases, buildOptimizerCases } from './golden-cases.mjs';

const HERE = path.dirname(fileURLToPath(import.meta.url));
// Alongside the tests now rather than at the repository root. They were at the root because
// the legacy extractor produced them; that extractor is gone, and the only thing that reads
